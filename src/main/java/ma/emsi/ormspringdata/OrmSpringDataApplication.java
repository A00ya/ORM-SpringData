...
public class OrmSpringDataApplication {
    ...
    CommandLineRunner start(IService service){
        return args -> {
            Stream.of("Aymane","Khalid","Houssam","Othman")
                    .forEach(nom -> {
            ...
            Patient patient = service.ChercherPatientParNom("Othman");
            Medecin medecin = service.ChercherMedecinParNom("ilyass");
            ...
            consultation.setRapport("rapport 123");
